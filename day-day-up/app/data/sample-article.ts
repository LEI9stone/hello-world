  ...
  },
  {
    ...
    sentences: [
      ...
      },
      {
        ...
        translation: '程序由包构建而成，包的特性可以实现对依赖项的高效管理。',
        words: [
          {
            word: 'Programs',
            phonetic: '/ˈproʊɡræmz/',
    ...
    sentences: [
      {
        ...
        translation: '语法采用扩展巴科斯-诺尔范式（EBNF）的一种变体来定义：',
        words: [
          { word: 'The', phonetic: '/ðə/', meaning: 'art. 这；该' },
          { word: 'syntax', phonetic: '/ˈsɪntæks/', meaning: 'n. 语法' },
          { word: 'is', phonetic: '/ɪz/', meaning: 'v. 是' },
      ...
      },
      {
        ...
        words: [
          ...
          { word: 'names', phonetic: '/neɪmz/', meaning: 'n. 名称（复数）' },
          ...
          { word: 'lexical', phonetic: '/ˈleksɪkl/', meaning: 'adj. 词法的' },
          {
            word: '(terminal)',
            phonetic: '/ˈtɜːmɪnl/',
            meaning: 'adj. 终结的',
